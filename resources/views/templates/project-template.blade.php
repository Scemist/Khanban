...
<html lang="pt-BR">
	...
	<body>
		...
		<aside>
			...
			<div class="group">
				<button>
					<svg width="16" height="16" fill="currentColor" class="bi bi-easel3-fill" viewBox="0 0 16 16"><path d="M8.5 12v1.134a1 1 0 1 1-1 0V12h-5A1.5 1.5 0 0 1 1 10.5V3h14v7.5a1.5 1.5 0 0 1-1.5 1.5h-5Zm7-10a.5.5 0 0 0 0-1H.5a.5.5 0 0 0 0 1h15Z"/></svg>
					Grupo
				</button>
				<ul>	
					<li><button id="criar-projeto">Adicionar Pessoa</button></li>
					<li><a href="#"><button>Gerenciar</button></a></li>
				</ul>
			</div>
			
			<div class="group">
				<button>
					<svg width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16"><path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/></svg>
					Filtros
				</button>
				<ul>
					<li><button>Vencendo Hoje</button></li>
					<li><button>Para Mim</button></li>
				</ul>
			</div>
		</aside>
